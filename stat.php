...
//$home = $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'].$_SERVER['PHP_SELF'];    // определяем страницу сайта
$home = $_SERVER['HTTP_HOST'] .$_SERVER['PHP_SELF'];    // определяем страницу сайта
//$cid=$_COOKIE["id"];
$cid="ID";
$lines = file($file);
while(count($lines) > $col_zap) array_shift($lines);
$lines[] = $date."|".$bot."|".$ip."|".$home."|".$cid."|\r\n";
